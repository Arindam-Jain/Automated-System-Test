    ...
    Object.defineProperty(this, 'run', {
      ...
      get: () => (...args) => {
        if (!cds._deprecationWarningForRun) {
          LOG._warn && LOG.warn('[cds] req.run is deprecated and will be removed')
    ...
    Object.defineProperty(this._, 'shared', {
      get() {
        if (!cds._deprecationWarningForShared) {
          LOG._warn && LOG.warn('[cds] req._.shared is deprecated and will be removed')
    ...
    Object.defineProperty(this, 'attr', {
      get() {
        if (!cds._deprecationWarningForAttr) {
          LOG._warn && LOG.warn('[cds] req.attr is deprecated and will be removed')
