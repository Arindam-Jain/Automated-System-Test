...
const _sanitizeRow = (entity, element, row) => {
  ...
  if (entity.elements[element].isAssociation && row[element] !== null) {
    autoExpandToOneAssociations(entity.elements[element]._target, row[element])
  }

  if (entity.elements[element]._isStructured && row[element] !== null) {
...
module.exports = cds.env.effective.odata.refs ? autoExpandToOneAssociations : () => {}
