...
const _getTemplate = (model, targetName, { pick, ignore }, parent = null, entityMap = new Map()) => /* NOSONAR */ {
...
module.exports = (usecase, service, target, ...args) => {
  ...
  if (service.context) service = Object.getPrototypeOf(service)
